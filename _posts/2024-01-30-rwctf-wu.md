...
Hi, today is a blog post on that serves as a Write Up for the RealWorldCTF 2024's challenge named "Let's party in the house". I've written this article for [Hackcyom](https://www.hackcyom.com/), which is my current company. Please feel free to read the write up on their website: [RealWorldCTF: Let's party in the house - Write Up](https://www.hackcyom.com/2024/01/rwctf-lets-party-in-the-house-wu/).
