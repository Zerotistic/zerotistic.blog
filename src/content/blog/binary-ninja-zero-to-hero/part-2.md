---
title: "Part 2: The UI Tour"
description: "A tour of Binary Ninja's UI: the *LIL levels, SSA form, the stack view and tags."
date: 2023-09-26
order: 2
authors:
  - zerotistic
...
Today I'm back with another part of the series! I'm very excited to post this one, as the next part will start diving into the API. As said previously, in this post we'll explore additional plugins, go into different views such as the \*LIL and SSA, and unlock the full potential of Binary Ninja's UI with tools like the stack view, tags, and the memory map.

## Binja UI tour

So, let's do a tour of Binja's UI and see how each component can be useful (and used).

### \*LIL and SSA

\*LIL are LLIL, MLIL and HLIL. They all have different levels of abstraction, and you can learn much more about them by reading [this blog post](https://blog.trailofbits.com/2017/01/31/breaking-down-binary-ninjas-low-level-il/) from Trail of Bits. I'll nonetheless talk about them, just not as in depth as it's not currently necessary.
...
Here is an example of how an x86 assembly instruction might be represented in LLIL:
...
![CFG without SSA](./assets/part-2/SSA_example1.1.png)
_CFG without SSA (taken from Wikipedia)_

However, if I were to present this CFG in SSA form and asked "what is the value of X2?", you would be able to answer "2".

![CFG with SSA](./assets/part-2/SSA_example1.2.png)
...
![CFG with SSA and phi](./assets/part-2/SSA_example1.3.png)
...
The stack view lives up to its name by providing a visual representation of the stack, although it differs from the typical debugger's stack view. Indeed, you won't see addresses or actual data, but rather the layout of the stack.

Here is a simple screenshot to illustrate what I'm saying:

![Stack View](./assets/part-2/stack_view.png)
...
![How to add tags](./assets/part-2/tags_add.png)
_Showcase how to add tags_

Now with all this new knowledge you should be able to use the basic features of Binja without any issues. However, you're missing one of the best (imo) features of Binja: its API. This is what I'll talk about in the next post, and showcase a few simple uses. See you soon!
